    ...
    public class Startup
    {
        public void Configuration(IAppBuilder appBuilder)
        {
            ...
            var options = new IdentityServerOptions
            {
                ...
                SigningCertificate = Certificate.Get(), //may have to add to local cert store
                Factory = factory,
            };
        ...
        public static IEnumerable<Client> Get()
        {
            return new[]
            {
                new Client
                {
                    ...
                    {
                        // There is only ONE dammit! (and its the client app in this project)
